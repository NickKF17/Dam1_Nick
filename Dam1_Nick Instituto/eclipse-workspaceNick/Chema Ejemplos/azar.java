...
public class Dam1 {
	...
	public static void main(String[] args) {
		...
		// Para generar un número aleatorio entre el 1 y el 6, por ejemplo, hacemos esto:
		...
		System.out.println("Tirada de dado de 6 caras: " + dado);
		// Pero si te das cuenta no ganas mucho (aún tienes que hacer la misma operación que antes
