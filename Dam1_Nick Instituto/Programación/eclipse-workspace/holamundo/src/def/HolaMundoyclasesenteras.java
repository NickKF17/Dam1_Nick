...
public class HolaMundoyclasesenteras {
	...
	// dos formas de escribir el bucle while, una con un numero cualquiera para entrar al bucle y otra sin numero para entrar
		int i;
	//int i= 5;
		do {
		//while(i!=0) {//se puede poner while(true) y al final del todo break pero es muy poco practico
			System.out.println("Elige un numero");
			i=teclado.nextInt();
		}	while(i!=0);
		//cambia el while del final y la varianle que esta con //
