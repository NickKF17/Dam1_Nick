def compararFechas(fecha1, fecha2):
    def comprobacion(fecha):
        try:
            ...
            return None
    fecha1 = comprobacion(fecha1)
    fecha2 = comprobacion(fecha2)
    if fecha1 is None or fecha2 is None:
        return "Las fechas no son fechas existentes."
    if fecha2 < fecha1:
        ...
        return "Las dos fechas son las mismas."
