...
Select facultades.nombre as facultad , facultades.codigo as codigo_facultad, count(profesores.id_profesor) as num_profesores, sum(profesores.salario) as masa_salarial,round(avg(profesores.salario),2) as salario_medio from profesores
join facultades Using(id_facultad)
