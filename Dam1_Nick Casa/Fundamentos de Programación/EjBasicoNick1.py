...
usuario1 = Usuario("Nick", activo=True, multas=0)
usuario2 = Usuario("Ariadna", activo=True, multas=50)
libro1 = Libro("Geronimo Stilton", disponible=True)
libro2 = Libro("Libertad", disponible=False)
